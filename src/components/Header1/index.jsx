                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <p className="text-left"> 
                          <button className="btn btn-success btn-block btn-sm" onClick={()=>navigate(`/dashboard/pages`)}>
                            Admin Console
                          </button>
                          <button className="btn btn-primary btn-block btn-sm" onClick={()=>navigate(`/dashboard/profile`)}>
                            View Profile
                          </button>
                          <button className="btn btn-secondary btn-block btn-sm" onClick={()=>navigate(`/dashboard/activate`)}>
